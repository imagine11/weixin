...
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" >会议达人后台管理</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="/aboutHui.shtml">H-ui</a> 
		...
		<nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
			<ul class="cl">
				...
				<li class="dropDown dropDown_hover">
					<a href="#" class="dropDown_A">${sessionScope.adminUser.uname } <i class="Hui-iconfont">&#xe6d5;</i></a>
...
<aside class="Hui-aside">
	<div class="menu_dropdown bk_2">
		<dl id="menu-article">
			...
			<dd>
				<ul>
					<li><a data-href="role/list" data-title="角色列表" href="javascript:void(0)">角色列表</a></li>
		...
		<dl id="menu-admin">
			...
			<dd>
				<ul>
					<li><a data-href="meetingPub/list" data-title="发单列表" >发单列表</a></li>
...
<section class="Hui-article-box">
	<div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
		<div class="Hui-tabNav-wp">
			<ul id="min_title_list" class="acrossTab cl">
				<li class="active">
					<span title="我的桌面" data-href="pages/manager/welcome.jsp">我的桌面</span>
					<em></em></li>
		</ul>
	</div>
	...
	<div id="iframe_box" class="Hui-article">
		<div class="show_iframe">
			...
			<iframe scrolling="yes" frameborder="0" src="pages/manager/welcome.jsp"></iframe>
	</div>
</div>
</section>
