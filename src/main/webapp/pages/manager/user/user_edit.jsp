	...
	<input type="hidden" name="id" value="${user.id }">
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">角色：</label>
					...
					<input type="radio"  onClick="changeStatuss(this)" <c:if test="${user.rid==1 }">checked="checked" </c:if> name="type" >
					<label for="checkbox-pinglun" id="statusLabelId">发单组</label>
				
				
					<input type="radio" onClick="changeStatuss(this)" <c:if test="${user.rid==2 }"> checked="checked" </c:if> name="type">
					<label for="checkbox-pinglun" id="statusLabelId">抢单组</label>
					
					<input type="radio" onClick="changeStatuss(this)" <c:if test="${user.rid==3 }"> checked="checked" </c:if> name="type">
					<label for="checkbox-pinglun" id="statusLabelId">查看组</label>
				
					<input type="radio" onClick="changeStatuss(this)" <c:if test="${user.rid==4 }"> checked="checked" </c:if> name="type">
					<label for="checkbox-pinglun" id="statusLabelId">VIP组</label>
