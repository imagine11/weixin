...
<article class="page-container">
	<form class="form form-horizontal" id="form-article-add" name="form-article-add" action="meetingPub/updateTo" method="post">
	<input type="hidden" name="id" value="${meetingPub.id }">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="ptime" name="ptime">
			</div>
		</div>
		...
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">课题类别：</label>
					...
					<input type="radio"  onClick="changeStatuss(this)" value="JAVA" checked="checked"  name="type" >
					<label for="checkbox-pinglun" id="statusLabelId">JAVA</label>
				
				
					<input type="radio" onClick="changeStatuss(this)" value="数据库" name="type">
					<label for="checkbox-pinglun" id="statusLabelId">数据库</label>
					
					<input type="radio" onClick="changeStatuss(this)" value="PHP" name="type">
					<label for="checkbox-pinglun" id="statusLabelId">PHP</label>
				
					<input type="radio" onClick="changeStatuss(this)" value="HTML5" name="type">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="ptitle" name="ptitle">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>地区：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" placeholder="" id="zone" name="zone">
			</div>
		</div>
		<div class="row cl">
